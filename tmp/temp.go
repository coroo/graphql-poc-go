...
// var products = getAnotherJson("https://staging-product.superyou.co.id/api/v1/products")
// var myClient = &http.Client{Timeout: 10 * time.Second}

// func getAnotherJson(url string) []Product {
...
func getProductData() []Product{
	...
	getJson("https://staging-product.superyou.co.id/api/v1/products", products)
	return *products
}
